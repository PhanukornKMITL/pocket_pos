                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        ..._salesDetail.map((item) {
                          ...
                          final optionsJson = item['options'] as String?;
                          if (optionsJson != null && optionsJson.isNotEmpty) {
                            try {
                              final optionsList = jsonDecode(optionsJson) as List;
                              final optionNames = optionsList.map((o) => o['name'] as String).toList();
                              optionDisplay = ' (${optionNames.join(', ')})';
                            } catch (_) {}
                          }
                          
                          final displayName = productName + optionDisplay;
